# Screen-Recording Notes — NLSE Soliton & Rogue Wave Stage Floor

## Goal
Capture a 1920 × 1080, 30 fps screen recording of the NLSE space-time
amplitude surface morphing through four wave structures:
soliton collision → Akhmediev breather → KM breather → Peregrine rogue wave.
...
1. **New Scene** → name it `nlse-floor`.
